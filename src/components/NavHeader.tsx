            ...
            <div className='flex gap-4 bg-secondary p-4 mr-0 rounded-lg'>
              {true &&
                <div className='flex flex-row gap-4 items-center justify-center'> 
                  ...
                  <Button className='p-3 shadow-md shadow-black border-none bg-gradient-to-br from-violet-500 to-orange-300 text-white rounded-xl' onClick={()=>setAddDialog(true)}>Add Event</Button>
                </div>
              }
              <Themetoggle/>
            </div>
